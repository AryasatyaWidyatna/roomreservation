      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Bergabunglah dengan Room Reservation</p>
          </div>

          {/* Success Message */}
          {success && (
            <div className="mb-6 p-4 bg-green-500/20 border border-green-500/30 rounded-xl flex items-center gap-3 text-green-700">
              <CheckCircle className="w-5 h-5" />
              <span>Registrasi berhasil! Mengalihkan ke halaman reservasi...</span>
            </div>
          )}
